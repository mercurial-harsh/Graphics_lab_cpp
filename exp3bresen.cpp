...
void names()
{
    ...
    glColor3f(1.0,1.0,0.0);
    assigncolor(10,50,GLUT_BITMAP_8_BY_13,"HARSH GUPTA || 500053088");
    glColor3f(0.0,1.0,0.0);
    assigncolor(10,25,GLUT_BITMAP_8_BY_13,"KUNAL VISOULIYA || 500053028");
}
...
void mouseclick(int button, int state, int x, int y)
{
    ...
    if(button == GLUT_LEFT_BUTTON && state == GLUT_DOWN && p.counter == 0) {
        ...
        p.y2 = 500-y;
        p.counter--;
        plotline((int)p.x1,(int)p.y1,(int)p.x2,(int)p.y2);
    }
